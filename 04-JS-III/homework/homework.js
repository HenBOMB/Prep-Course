...
  // Si no se pasan argumentos devuelve 0. Si se pasa 1 argumento, simplemente devuélvelo
  // Escribe tu código aquí:
  if(arguments.length === 0 || !arguments.length) return 0;
...
function diaDeLaSemana(numeroDeDia) {
  ...
  //Escribe tu código aquí   
  // const dia = ['Domingo', 'Lunes', 'Martes', 'Miercoles', 'Jueves', 'Viernes', 'Sabado'][numeroDeDia-1];
